...
import com.wzz.game_console.items.GameConsoleItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> game_console = REGISTRY.register("game_console", GameConsoleItem::new);
}
